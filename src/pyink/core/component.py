...
:class:`pyink.core.element.Element`. Two concrete kinds exist:
...
from pyink.core import signal as _signal
...
class ComponentInstance:
    ...
    1. Binds this instance as the current component via
       :func:`pyink.core.signal._set_current_component` so ``effect(...)``
    ...
    # -- Effect binder hook (called from pyink.core.signal.effect) ---------
