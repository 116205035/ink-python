...
:func:`pyink.render.pipeline.render` around the initial mount. Because
...
goes through :mod:`pyink.core.signal`'s ``_current_component`` exactly
...
_current_instance: ContextVar[Instance | None] = ContextVar(
    "pyink_current_instance", default=None
)
