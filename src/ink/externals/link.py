...
* This is the same pattern :func:`ink.components.Transform` uses — the
...
cells. :mod:`ink.layout.measure` was extended to strip OSC sequences
...
#: Matches :func:`ink.components.Transform`'s fallback.
