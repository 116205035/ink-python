...
an :class:`ink.render.instance.Instance`.

The render loop is a regular :func:`ink.core.signal.effect`. Its body
...
a :class:`ink.render.instance._FpsThrottle`, which coalesces a burst
...
from ink.hooks._runtime import (
